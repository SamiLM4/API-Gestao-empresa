...
require_once "modelo/jwt/JWT.php";
require_once "modelo/jwt/Key.php";
require_once "modelo/jwt/SignatureInvalidException.php";

require_once "modelo/jwt/ExpiredException.php";
...
class MeuTokenJWT2
{
    ...
    public function gerarToken($parametro_claims)
    {
        ...
        $objPayload->data_nascimento = $parametro_claims->data_nascimento;
